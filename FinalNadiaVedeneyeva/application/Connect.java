...
import application.ConnectFour.Cell;
...
//--------------------------------------------------------------------------------------------------------//
		...
		//----------------------Game---------------------------------//
            ...
            public void handle(ActionEvent event) {
            	...
            	selectPlayer.getChildren().clear();
...
//----------------------Class Game---------------------------------//
	...
	public class Game extends Cell {
		...
		public Game() {
			...
			ImageView player1Banner = new ImageView(new Image(player1URL, 100, 100, true, true)); 
			ImageView player2Banner = new ImageView(new Image(player2URL, 100, 100, true, true)); 
			
			Circle blueCircle = new Circle(30);
			...
			header.getChildren().addAll(player1Banner, blueCircle, bannerText, greenCircle, player2Banner);
			
			banner.getChildren().addAll(bannerRectangle, header);
	...
	//-----------------------------------Avatar on Mouse Clicked-----------------------------------------------------//			
	    ...
	    public void setAvatar(int i, int j) {
			...
			if (player == "player1") {	
				...
				Circle blue = new Circle(30);
				
				blue.setFill(Color.BLUE);
				blue.setStroke(Color.BLACK);

				pane.add(blue, i, j);
				pane.setHalignment(blue, HPos.CENTER); 
				pane.setValignment(blue, VPos.CENTER);
				
	
				//ImageView avatar1 = new ImageView(new Image(player1URL, 80, 80, true, true));
				...
				pane.add(green, i, j);
				pane.setHalignment(green, HPos.CENTER); 
				pane.setValignment(green, VPos.CENTER);
				//ImageView avatar2 = new ImageView(new Image(player2URL, 80, 80, true, true));
...
//		    				cell[i][j].getChildren();
//		    				cell[i + 1][j].getChildren();
//		    				cell[i + 2][j].getChildren();
//		    				cell[i + 3][j].getChildren();
		    			}
